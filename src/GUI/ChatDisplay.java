...
public class ChatDisplay extends JFrame {
    ...
    public ChatDisplay(Client client, Chat chat, Person person) {
        this.client = client;
        ...
        messages.setPreferredSize(new Dimension(600, 600));
        messages.setEditable(false);
        messages.setMinimumSize(new Dimension(5, 5));
        messages.setMaximumSize(new Dimension(5, 5));
        panel.add(messages);


        /*interactivePanel = new JPanel();
        interactivePanel.setBorder(BorderFactory.createEmptyBorder(30,30,10,30));
        interactivePanel.setLayout(new GridLayout(1,1));
    ...
    public static void main(String[] args) {
        ...
        chat.receiveMessage(
            new Message("WWWWWWWWWWWWWWWWWWWWWWWWWWWWW", "chai", null, ABORT)
        );
        chat.receiveMessage(
            new Message("WWWWWWWWWWWWWWWWWWWWWWWWWWWWW", "sanjana", null, ABORT)
        );
